...
/// </summary>
/// <remarks>
/// У каждой вкладки своя панель. Панель скрытой вкладки сохраняет загруженное содержимое,
/// кроме крупных файлов — их страница выгружает и перезапрашивает при показе. Показ панели
/// следует за показом терминала вкладки. Создаёт панель только <see cref="ShowPendingAsync"/>;
/// закрывает её только пользователь.
/// </remarks>
